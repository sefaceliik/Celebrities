...
class CelebrityListAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        val celebrity: Celebrity = celebrityDatabase?.celebritiesList?.get(p0) ?: Celebrity("No Actor","No Des",R.drawable.placeholder,false)
    ...
    override fun getItem(p0: Int): Any {
        ...
        return celebrityDatabase?.celebritiesList?.get(p0) ?: Celebrity("No Actor","No Des",R.drawable.placeholder,false)
    }
